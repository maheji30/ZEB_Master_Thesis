...
\usepackage{cite}                                    
 % se usa para la bibliograf'ia este no lo usa ulises
...
\input{capitulos/introduccionGBV}
%\input{capitulos/escritura}
%\input{capitulos/figuras}
