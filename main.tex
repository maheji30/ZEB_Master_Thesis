\documentclass[spanish,10pt]{tesisIER}
...
\usepackage[activeacute]{babel}				% este es el delos acentos as'i
...
%%	PATH FIGURAS
\graphicspath{{figs/}}  %define el subdirectorio donde latex busca las figuras



%%	VARIOS

\title{Levitaci\'on de part\'iculas en ondas de sonido usando el m\'etodo de la ecuaci\'on de Boltzmann en redes}
